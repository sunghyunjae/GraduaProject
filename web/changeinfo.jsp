                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <h3> <center>비밀 번호 확인 </center> </h3>
                                <br /> <form action="change.jsp" method="post">
                                <br />
                                <br /> 지금 비밀번호 : <input id="now_pw" name="now_pw">
                                <br />
                                <br /> <button class="btn-primary btn-block" > 변경 </button> </form>
                                <br /> <button class="btn-primary btn-block" onClick="location.href='login.jsp'"> 취소 </button>
                            </div>
                        </div>
                    </div>
                </div>

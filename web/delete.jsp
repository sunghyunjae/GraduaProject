            ...
            <center>
                ...
                <form name=form1 action="control.jsp" method="post">
                    <input type=hidden name="action" value="delete">
                        <h3>삭제를 하고자 하는 하는 학생의 학번을 입력해주세요</h3>
                        <div class="form-group">
                            <input name="student_id" type = "text" class="form-control form-control-user" id="student_id" aria-describedby="emailHelp" placeholder="학번" style ="width:200px;">
                        </div>

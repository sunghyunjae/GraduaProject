    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <center>
                    <h1> 도서관 기숙사 출입</h1>
                    <a class="btn btn-primary  btn-icon-split" href="control.jsp?action=enterDomitory" >
                        <span class="icon text-white-50">
                        <i class="fas fa-check"></i>
                        </span>
                        <span class="text">기숙사 입실</span>
                    </a>
                <a class="btn btn-primary  btn-icon-split" href="control.jsp?action=quitDomitory" >
                        <span class="icon text-white-50">
                        <i class="fas fa-check"></i>
                        </span>
                    <span class="text">기숙사 퇴실</span>
                </a>
                <a class="btn btn-primary  btn-icon-split" href="control.jsp?action=enterLibrary" >
                        <span class="icon text-white-50">
                        <i class="fas fa-check"></i>
                        </span>
                    <span class="text">도서관 입실</span>
                </a>
                <a class="btn btn-primary  btn-icon-split" href="control.jsp?action=quitLibrary" >
                        <span class="icon text-white-50">
                        <i class="fas fa-check"></i>
                        </span>
                    <span class="text">도서관 퇴실</span>
                </a>
                    </center>
                    <% } %>
